...
from .views import home_view, login_view, forgot_password, register_view , otp_view,reset_password,registered_for,register_info,service_needed, member_detail,patient_detail
