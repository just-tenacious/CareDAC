...
#     Email must have been verified through 'forgot_password' OTP flow.
#     """
#     email = request.session.get('otp_email')  # Email saved during OTP verification

#     if not email:
#         messages.error(request, "Session expired or invalid access. Please request a new password reset.")
...
#     """
#     Handles OTP verification for login, registration, and password reset.
#     """
#     source = request.GET.get("source")  # 'login', 'register', or 'forgot_password'
#     email = request.session.get("otp_email")

#     if request.method == "POST":
#         # Combine multiple OTP inputs if present
